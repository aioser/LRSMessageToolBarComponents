...
@implementation LRSMessageToolBarPageControl
...
- (void)drawRect:(CGRect)rect {
    ...
    for (int i = 0; i < numberOfPages; i++) {
        ...
        if (i == currentPage) {
            if (type == LRSMessageToolBarPageControlTypeFullOffFull || type == LRSMessageToolBarPageControlTypeFullOffEmpty) {
            ...
            if (type == LRSMessageToolBarPageControlTypeEmptyOffEmpty || type == LRSMessageToolBarPageControlTypeFullOffEmpty) {
...
- (void)setType:(LRSMessageToolBarPageControlType)aType {
    type = aType;
