...
Pod::Spec.new do |s|
  s.name             = 'LRSMessageToolBar'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LRSMessageToolBar.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/刘sama/LRSMessageToolBar.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'LRSMessageToolBar' => ['LRSMessageToolBar/Assets/*.png']
  # }
